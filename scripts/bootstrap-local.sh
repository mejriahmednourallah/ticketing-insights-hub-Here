...
REDMINE_FIELD_NATURE="$(escape_env_value "${REDMINE_FIELD_NATURE:-}")"
REDMINE_FIELD_INTERVENTION_TYPE="$(escape_env_value "${REDMINE_FIELD_INTERVENTION_TYPE:-}")"
REDMINE_FIELD_RESOLVED_DATE="$(escape_env_value "${REDMINE_FIELD_RESOLVED_DATE:-}")"
