...
GROQ_API_KEY=CHANGE_ME_ROTATE_THE_EXPOSED_KEY
GROQ_MODEL=llama-3.3-70b-versatile
AI_PROVIDER_ORDER=lovable,groq
...
echo "Edit REDMINE_API_KEY and at least one AI key (LOVABLE_API_KEY or GROQ_API_KEY) before deployment."
